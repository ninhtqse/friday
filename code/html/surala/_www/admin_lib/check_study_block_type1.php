...
//				" WHERE student_num='".$_SESSION['managerid']['manager_num']."'" .
//				" AND DATE_FORMAT(regist_time,'%Y-%m-%d')=DATE_FORMAT(now(),'%Y-%m-%d')" .
//				" AND block_num='".$_SESSION['course']['block_num']."'" .
//				" AND again='1' AND class_m='".$_SESSION['record']['class_m']."'" .
