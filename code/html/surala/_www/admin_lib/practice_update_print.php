...
function default_html($L_NAME,$ERROR) {
	...
	if ($local_time || $remote_time) {
		$submit_msg = $L_NAME['course_name']." のまとめプリントファイルを本サーバーへアップしますがよろしいですか？";

		$html .= "まとめプリントファイルをアップする場合は、「アップする」ボタンを押してください。<br>\n";
...
function update() {
	...
	$local_dir = MATERIAL_PRINT_DIR;
	$remote_dir = REMOTE_MATERIAL_PRINT_DIR;
