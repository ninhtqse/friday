...
function default_html($ERROR) {
	...
	if ($local_time || $remote_time) {
		$submit_msg = "学力診断テスト単元マスタ情報を検証へアップしますがよろしいですか？";

		$html .= "学力診断テスト単元マスタ情報をアップする場合は、「アップする」ボタンを押してください。<br>\n";
		$html .= "<form action=\"".$_SERVER[PHP_SELF]."\" method=\"POST\">\n";
		...
		$html .= "学力診断テスト単元マスタ情報が設定されておりません。<br>\n";
	}
...
function update_end_html() {
	...
	$html  = "学力診断テスト単元マスタ情報のアップが完了致しました。<br>\n";
	$html .= "<br>\n";
	$html .= "<form action=\"".$_SERVER[PHP_SELF]."\" method=\"POST\">\n";
