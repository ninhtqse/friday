...
class teacher_enterprise_daily_summary_evac extends baseTable {

	public function getTableName() {
		return "teacher_enterprise_daily_summary_evac";
	}
	...
	public function getSQL() {
		...
		$sql .= " INNER JOIN mv_0_enterprise s ON ".$this->getTableName().".enterprise_id = s.enterprise_id";
		return $sql;
	}
	...
	public function getDeleteSQL() {
		...
		$sql .= " INNER JOIN mv_0_enterprise m ON m.enterprise_id = t.enterprise_id ";
		$del_list[] = $sql;
		return $del_list;
	}
