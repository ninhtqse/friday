...
class target_study_test_problem extends baseTable {

	public function getTableName() {
		return "target_study_test_problem";
	}
	...
	public function extendInsert($db_saki) {
		...
		$sql .= " ,t.problem_num";
		$sql .= " ,t.problem_table_type";
		$sql .= " ,t.problem_point";
		$sql .= " ,t.display_problem_num";
		$sql .= " ,t.answer_input";
		$sql .= " ,t.standard_time";
		$sql .= " ,t.problem_answer_time";
		$sql .= " ,t.set_words";
		$sql .= " ,t.answer2";
		$sql .= " ,t.result";
		$sql .= " ,t.list_num";
